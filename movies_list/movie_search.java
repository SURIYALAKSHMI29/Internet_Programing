...
public class movie_search extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("strong{color:royalblue; font-family:algerian; font-size:1.4em}");
            out.println("strong.err{color:red; font-family:arial;}");
            out.println("</style>");
            out.println("</head>");
            out.println("<body>");
            ...
            if(f==0){
                out.println("<strong class='err'> Sorry, your search '"+search+"' has no results!</strong><br>");
            }
